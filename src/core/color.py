...
def parse_color(*args, color_mode='RGB', normed=False, **kwargs):
    ...
    if not (hsb is None):
        ...
        if not normed:
            ...
            s = mathutils.constrain(s / color_range[1], 0, 1)
    ...
    if not (rgb is None):
        ...
        if not normed:
            ...
            green = mathutils.constrain(g / color_range[1], 0, 1)
            blue = mathutils.constrain(b / color_range[2], 0, 1)
        else:
            red, green, blue = r, g, b

    if not normed:
        alpha = mathutils.constrain(alpha / color_range[3], 0, 1)
...
class Color:
    ...
    @gray.setter
    def gray(self, value):
        value = mathutils.constrain(value / 255, 0, 1)
        self._red = value
        self._green = value
        self._blue = value
        self._recompute_hsb()
    ...
    def alpha(self, value):
        self._alpha = mathutils.constrain(value / color_range[3], 0, 1)
    ...
    @red.setter
    def red(self, value):
        self._red = mathutils.constrain(value / color_range[0], 0, 1)
        self._recompute_hsb()
    ...
    def green(self, value):
        self._green = mathutils.constrain(value / color_range[1], 0, 1)
        self._recompute_hsb()
    ...
    @blue.setter
    def blue(self, value):
        self._blue = mathutils.constrain(value / color_range[2], 0, 1)
        self._recompute_hsb()
    ...
    @hue.setter
    def hue(self, value):
        self._hue = mathutils.constrain(value / color_range[0], 0, 1)
        self._recompute_rgb()
    ...
    def saturation(self, value):
        self._saturation = mathutils.constrain(value / color_range[1], 0, 1)
        self._recompute_rgb()
    ...
    def brightness(self, value):
        self._brightness = mathutils.constrain(value / color_range[2], 0, 1)
        self._recompute_rgb()
